    ...
    document.addEventListener('webkitfullscreenchange', function (t) {
        ...
        r === e
            ? e.style.width &&
              ...
              (e.style.height = '100%'))
            : p &&
              ((e.style.width = p), (e.style.height = g), (p = ''), (g = ''));
    });
    var m = {
        Module: c,
                ...
                return (
                    ...
                    fetch(t, r).then(function (t) {
                        ...
                        var a =
                            ...
                            s =
                                'undefined' !=
                                typeof t.headers.get('Content-Length'),
                            i = e(t, s),
                            d = new Uint8Array(i),
                            u = [],
                            l = 0,
        ...
        (c.cachedFetch = (function () {
            ...
            function a(e, t) {
                return (
                    ...
                    (!t ||
                        ['must-revalidate', 'immutable'].indexOf(t.control) !=
                            -1) &&
                    !!e.match('^https?://')
                );
            }
