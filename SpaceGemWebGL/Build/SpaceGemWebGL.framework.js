function unityFramework(Module) {
    ...
    var asmLibraryArg = {
        ...
        Be: _JS_Sound_SetPosition,
        Ae: _JS_Sound_SetVolume,
        ka: _JS_Sound_Stop,
        ea: _JS_SystemInfo_GetCanvasClientSize,
        Jb: _JS_SystemInfo_GetDocumentURL,
        eb: _JS_SystemInfo_GetGPUInfo,
        kb: _JS_SystemInfo_GetMatchWebGLToCanvasSize,
        fb: _JS_SystemInfo_GetMemory,
        gb: _JS_SystemInfo_GetOS,
        ib: _JS_SystemInfo_GetPreferredDevicePixelRatio,
        Td: _JS_SystemInfo_GetScreenSize,
        me: _JS_SystemInfo_HasAstcHdr,
        hb: _JS_SystemInfo_HasCursorLock,
        $d: _JS_SystemInfo_HasFullscreen,
        ma: _JS_SystemInfo_HasWebGL,
        Pd: _JS_SystemInfo_IsMobile,
        ...
        Qg: ___cxa_find_matching_catch_4,
        ...
        Zd: _emscripten_exit_fullscreen,
        Ud: _emscripten_exit_pointerlock,
        Rd: _emscripten_get_canvas_element_size,
        Yd: _emscripten_get_fullscreen_status,
        za: _emscripten_get_gamepad_status,
        Nc: _emscripten_get_heap_max,
        F: _emscripten_get_now,
        Aa: _emscripten_get_num_gamepads,
        ...
        xb: _emscripten_set_gamepaddisconnected_callback_on_thread,
        ...
        Fb: _emscripten_set_mousedown_callback_on_thread,
        Eb: _emscripten_set_mousemove_callback_on_thread,
        Gb: _emscripten_set_mouseup_callback_on_thread,
        zb: _emscripten_set_touchcancel_callback_on_thread,
        Bb: _emscripten_set_touchend_callback_on_thread,
        Ab: _emscripten_set_touchmove_callback_on_thread,
        Cb: _emscripten_set_touchstart_callback_on_thread,
        ...
        Eg: _glAttachShader,
        Ub: _glBeginQuery,
        uf: _glBeginTransformFeedback,
        ta: _glBindAttribLocation,
        Dg: _glBindBuffer,
        Ve: _glBindBufferBase,
        Ue: _glBindBufferRange,
        Ag: _glBindFramebuffer,
        Bg: _glBindRenderbuffer,
        Pe: _glBindSampler,
        Cg: _glBindTexture,
        nf: _glBindTransformFeedback,
        qf: _glBindVertexArray,
        jc: _glBlendEquation,
        kc: _glBlendEquationSeparate,
        lc: _glBlendFuncSeparate,
        ef: _glBlitFramebuffer,
        yg: _glBufferData,
        zg: _glBufferSubData,
        xg: _glCheckFramebufferStatus,
        tg: _glClear,
        Le: _glClearBufferfi,
        Ke: _glClearBufferfv,
        ...
        Ta: _glColorMask,
        sg: _glCompileShader,
        qg: _glCompressedTexImage2D,
        gf: _glCompressedTexImage3D,
        rg: _glCompressedTexSubImage2D,
        lf: _glCompressedTexSubImage3D,
        Ye: _glCopyBufferSubData,
        pg: _glCopyTexImage2D,
        ic: _glCopyTexSubImage2D,
        og: _glCreateProgram,
        ng: _glCreateShader,
        mg: _glCullFace,
        lg: _glDeleteBuffers,
        kg: _glDeleteFramebuffers,
        jg: _glDeleteProgram,
        Na: _glDeleteQueries,
        ig: _glDeleteRenderbuffers,
        Oe: _glDeleteSamplers,
        hg: _glDeleteShader,
        Pb: _glDeleteSync,
        gg: _glDeleteTextures,
        of: _glDeleteTransformFeedbacks,
        sf: _glDeleteVertexArrays,
        sa: _glDepthFunc,
        ra: _glDepthMask,
        fg: _glDetachShader,
        eg: _glDisable,
        dg: _glDisableVertexAttribArray,
        ag: _glDrawArrays,
        _e: _glDrawArraysInstanced,
        Xe: _glDrawBuffers,
        bg: _glDrawElements,
        Ze: _glDrawElementsInstanced,
        cg: _glEnable,
        $f: _glEnableVertexAttribArray,
        Vb: _glEndQuery,
        vf: _glEndTransformFeedback,
        Ob: _glFenceSync,
        Yf: _glFinish,
        Zf: _glFlush,
        bf: _glFlushMappedBufferRange,
        K: _glFramebufferRenderbuffer,
        J: _glFramebufferTexture2D,
        na: _glFramebufferTextureLayer,
        qa: _glFrontFace,
        Xf: _glGenBuffers,
        Tf: _glGenFramebuffers,
        Tb: _glGenQueries,
        Uf: _glGenRenderbuffers,
        Ne: _glGenSamplers,
        Wf: _glGenTextures,
        pf: _glGenTransformFeedbacks,
        tf: _glGenVertexArrays,
        ...
        Sf: _glGetError,
        Rf: _glGetFramebufferAttachmentParameteriv,
        Gg: _glGetIntegeri_v,
        ua: _glGetIntegerv,
        Re: _glGetInternalformativ,
        Qb: _glGetProgramBinary,
        Jg: _glGetProgramInfoLog,
        O: _glGetProgramiv,
        xf: _glGetQueryObjectuiv,
        wf: _glGetQueryiv,
        _f: _glGetRenderbufferParameteriv,
        Pf: _glGetShaderInfoLog,
        hc: _glGetShaderPrecisionFormat,
        Qf: _glGetShaderSource,
        Ig: _glGetShaderiv,
        Of: _glGetString,
        cf: _glGetStringi,
        Nf: _glGetTexParameteriv,
        Se: _glGetUniformBlockIndex,
        ...
        fc: _glPolygonOffset,
        Rb: _glProgramBinary,
        Me: _glProgramParameteri,
        We: _glReadBuffer,
        Y: _glReadPixels,
        Kf: _glRenderbufferStorage,
        df: _glRenderbufferStorageMultisample,
        Qe: _glSamplerParameteri,
        Ra: _glScissor,
        If: _glShaderSource,
        Jf: _glStencilFuncSeparate,
        Gf: _glStencilMask,
        Hf: _glStencilOpSeparate,
        Ef: _glTexImage2D,
        jf: _glTexImage3D,
        Ff: _glTexParameterf,
        Qa: _glTexParameteri,
        Df: _glTexParameteriv,
        ff: _glTexStorage2D,
        hf: _glTexStorage3D,
        Cf: _glTexSubImage2D,
        kf: _glTexSubImage3D,
        mf: _glTransformFeedbackVaryings,
        Wb: _glUniform1fv,
        oa: _glUniform1i,
        Xb: _glUniform1iv,
        Yb: _glUniform1uiv,
        ...
        ec: _glUniformMatrix3fv,
        pa: _glUniformMatrix4fv,
        af: _glUnmapBuffer,
        yf: _glUseProgram,
        Kg: _glValidateProgram,
        zf: _glVertexAttrib4f,
        Af: _glVertexAttrib4fv,
        Te: _glVertexAttribIPointer,
        Bf: _glVertexAttribPointer,
        Oa: _glViewport,
        Xa: invoke_dddi,
        Sg: invoke_dii,
        S: invoke_fffi,
        ...
        k: invoke_iiii,
        r: invoke_iiiii,
        Vg: invoke_iiiiifiiiii,
        v: invoke_iiiiii,
        u: invoke_iiiiiii,
        Q: invoke_iiiiiiii,
        Xg: invoke_iiiiiiiifiii,
        pc: invoke_iiiiiiiii,
        mc: invoke_iiiiiiiiii,
        _a: invoke_iiiiiiiiiii,
        xc: invoke_iiiiiiiiiiiii,
        od: invoke_iiiiiiiiiji,
        ld: invoke_iiiijii,
        zd: invoke_iiij,
        wd: invoke_iiijiii,
        xd: invoke_iij,
        ...
        wc: invoke_viiiiiiiiii,
        ca: invoke_viiiiiiiiiii,
        Ug: invoke_viiiiiiiiiiii,
        vc: invoke_viiiiiiiiiiiii,
        kd: invoke_viiij,
        md: invoke_viiiji,
        cd: invoke_viij,
        rd: invoke_viiji,
    ...
    var stackSave = (Module['stackSave'] = function () {
        return (stackSave = Module['stackSave'] = Module['asm']['ph']).apply(
            null,
            arguments
        );
    });
    ...
    var stackAlloc = (Module['stackAlloc'] = function () {
        return (stackAlloc = Module['stackAlloc'] = Module['asm']['rh']).apply(
            null,
            arguments
        );
    });
    var _setThrew = (Module['_setThrew'] = function () {
        return (_setThrew = Module['_setThrew'] = Module['asm']['sh']).apply(
            null,
            arguments
        );
    });
    ...
    var dynCall_v = (Module['dynCall_v'] = function () {
        return (dynCall_v = Module['dynCall_v'] = Module['asm']['Ph']).apply(
            null,
            arguments
        );
    });
    var dynCall_i = (Module['dynCall_i'] = function () {
        return (dynCall_i = Module['dynCall_i'] = Module['asm']['Qh']).apply(
            null,
            arguments
        );
    });
    ...
    var dynCall_ji = (Module['dynCall_ji'] = function () {
        return (dynCall_ji = Module['dynCall_ji'] = Module['asm']['xi']).apply(
            null,
            arguments
        );
    });
    ...
    var dynCall_fi = (Module['dynCall_fi'] = function () {
        return (dynCall_fi = Module['dynCall_fi'] = Module['asm']['Oi']).apply(
            null,
            arguments
        );
    });
    ...
    var dynCall_j = (Module['dynCall_j'] = function () {
        return (dynCall_j = Module['dynCall_j'] = Module['asm']['kj']).apply(
            null,
            arguments
        );
    });
    ...
    var dynCall_viddddddddddddi = (Module['dynCall_viddddddddddddi'] =
        function () {
            return (dynCall_viddddddddddddi = Module[
                'dynCall_viddddddddddddi'
            ] =
                Module['asm']['Yl']).apply(null, arguments);
        });
    ...
    var dynCall_viffffffffffffi = (Module['dynCall_viffffffffffffi'] =
        function () {
            return (dynCall_viffffffffffffi = Module[
                'dynCall_viffffffffffffi'
            ] =
    ...
    var dynCall_iiiiiiiiiiiiiifiiiiii = (Module[
    ...
    var dynCall_di = (Module['dynCall_di'] = function () {
        return (dynCall_di = Module['dynCall_di'] = Module['asm']['On']).apply(
            null,
            arguments
        );
    });
    ...
    var dynCall_ij = (Module['dynCall_ij'] = function () {
        return (dynCall_ij = Module['dynCall_ij'] = Module['asm']['ao']).apply(
            null,
            arguments
        );
    });
    ...
    var dynCall_vf = (Module['dynCall_vf'] = function () {
        return (dynCall_vf = Module['dynCall_vf'] = Module['asm']['No']).apply(
            null,
            arguments
        );
    });
    ...
    var dynCall_f = (Module['dynCall_f'] = function () {
        return (dynCall_f = Module['dynCall_f'] = Module['asm']['Vo']).apply(
            null,
            arguments
        );
    });
    ...
    var dynCall_ff = (Module['dynCall_ff'] = function () {
        return (dynCall_ff = Module['dynCall_ff'] = Module['asm']['Xo']).apply(
            null,
            arguments
        );
    });
    var dynCall_if = (Module['dynCall_if'] = function () {
        return (dynCall_if = Module['dynCall_if'] = Module['asm']['Yo']).apply(
            null,
            arguments
        );
    });
